...
export default function App() {
  ...
  return (
    <div className="w-[1920px] h-[1080px] relative" style={{ backgroundColor: '#FAF8FF' }}>
      ...
      {/* Import/Export Category Assignments */}
      <div 
        ...
        <button
          onClick={() => {
            ...
            if (data) {
              ...
              alert('Category assignments copied to clipboard! Paste this in the import field on Vercel.');
            } else {
              alert('No category assignments found.');
            }
          }}
          style={{
            fontSize: '12px',
        ...
        {showImportExport && (
          ...
          >
            <textarea
              ...
              placeholder="Paste exported assignments here..."
              style={{
                width: '100%',
                minHeight: '100px',
                padding: '8px',
              ...
              <button
                onClick={() => {
                  try {
                    ...
                    alert('Category assignments imported successfully!');
                  } catch (e) {
